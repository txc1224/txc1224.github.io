...
- **配套笔记**: Docker 基础、Dockerfile 最佳实践、Docker Compose 全栈编排
...
- **配套笔记**: Git 分支策略、Git rebase vs merge、Git PR 工作流
...
- **配套笔记**: GitHub Actions CI、CI/CD 流水线设计、部署策略
...
- 《Docker 实战》第 1-3 章(容器/镜像/分层)→ Docker 基础
- 《Docker 实战》第 5 章(Dockerfile / 多阶段构建)→ Dockerfile 最佳实践
- 《Docker 实战》第 8 章(Compose)→ Docker Compose 全栈编排
- 《Git 权威指南》第 3 章(分支 / rebase)→ Git rebase vs merge,Git 分支策略
- 《Git 权威指南》第 7 章(工具 / PR)→ Git PR 工作流
- 《CI/CD 实战》GitHub Actions 章节 → GitHub Actions CI
- 《CI/CD 实战》流水线设计章节 → CI/CD 流水线设计
- 《CI/CD 实战》部署策略章节 → 部署策略
